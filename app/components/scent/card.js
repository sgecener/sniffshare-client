...
export function ScentCard({ scent, className }) {
  return (
    <div >
      <Link href={`/scents/${scent.id}`}  className={`card ${className} flex flex-col md:flex-row md:items-stretch bg-white rounded-lg shadow-lg overflow-hidden mb-1 hover:bg-indigo-100 transition-colors duration-300`}>
